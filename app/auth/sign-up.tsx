...
export default function SignUpScreen() {
  ...
  const onSubmit = () => {
    if (!email.trim()) {
      Alert.alert('Check email', 'Enter any sample email for the demo.');
      return;
    }
    signUpDemo(email, name);
    Alert.alert('Welcome', 'Sample account created. Nothing is sent to a server.', [
    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <Text style={[Type.overline, styles.kickerMargin]}>SAMPLE SIGN UP</Text>
          <Text style={[styles.headline, Type.title]}>Create your Flooded account</Text>
          <Text style={[styles.lead, Type.body]}>
            Quiet signup for the demo. No marketplace styling — just your profile.
          </Text>
          ...
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="8+ characters (not validated)"
              placeholderTextColor={colors.placeholder}
              style={styles.input}
              secureTextEntry
            />
          ...
          <Pressable style={styles.secondary} onPress={() => router.push('/auth/sign-in')}>
